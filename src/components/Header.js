...
export const Header = () => {
  ...
  const inactveClass = 'text-base block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700';
  return (
    <header>
      <nav className='bg-white   border-b-2  border-gray-200 dark:bg-gray-900 dark:border-gray-700 '>
        <div className='max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4'>
          <Link to='/' className='flex items-center space-x-3 rtl:space-x-reverse'>
            ...
            <span className='self-center text-2xl font-semibold whitespace-nowrap dark:text-white'>Movmate</span>
          </Link>
          ...
          <div className='flex md:order-2'>
            ...
            <div className='relative hidden md:block'>
              ...
              <form onSubmit={handleSubmit}>
                <input type='text' id='search-navbar' name='search' className='block w-full focus:outline-none p-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500' placeholder='Search...' />
              </form>
            </div>
          ...
          <div className={`${hidden ? 'hidden' : ''} items-center justify-between  w-full md:flex md:w-auto md:order-1`} id='navbar-search'>
            ...
            <ul className='flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700'>
              <li>
                <NavLink to='/' className={({ isActive }) => (isActive ? activeClass : inactveClass)} end>
                  Home
                </NavLink>
              </li>
              <li>
                <NavLink to='/movies/popular' className={({ isActive }) => (isActive ? activeClass : inactveClass)}>
                  Popular
                </NavLink>
              </li>
              <li>
                <NavLink to='/movies/top' className={({ isActive }) => (isActive ? activeClass : inactveClass)}>
                  Top
                </NavLink>
              </li>
              <li>
                <NavLink to='/movies/upcoming' className={({ isActive }) => (isActive ? activeClass : inactveClass)}>
                  Upcoming
                </NavLink>
              </li>
            </ul>
